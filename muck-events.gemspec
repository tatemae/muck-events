...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "test/rails_test/db/migrate/20091112182339_create_events.rb",
     ...
     "test/rails_test/spec/controllers/admin/profiles_controller_test.rb",
